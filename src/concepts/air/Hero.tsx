...
// Must match .concept-air's --primary in air.css.
const ACCENT = "oklch(0.38 0.05 165)";
 ...
 * kept identical across every concept per request. The quiet split
 * photo+statement that used to be the hero is now its own section (see
 * Statement.tsx). */
export function AirHero({ autoIntroReady = false }: { autoIntroReady?: boolean }) {

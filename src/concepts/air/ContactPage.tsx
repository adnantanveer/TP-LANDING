...
export function AirContactPage() {
  ...
  return (
    <main id="top" className="concept-air relative">
      ...
      <section className="relative bg-background pb-32 pt-40 md:pb-48 md:pt-56">
        <div className="mx-auto grid max-w-4xl grid-cols-1 gap-16 px-6 md:grid-cols-2 md:gap-24 md:px-12">
          <Reveal>
            <h1 className="max-w-sm text-[clamp(2rem,4vw,2.8rem)] leading-[1.15]">{contactInfo.heading}</h1>

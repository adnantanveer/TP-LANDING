...
// Must match .concept-surge's --primary in surge.css.
const ACCENT = "oklch(0.66 0.27 345)";
 ...
 * kept identical across every concept per request. The floating-blob
 * statement that used to be the hero is now its own section (see
 * Statement.tsx). */
export function SurgeHero({ autoIntroReady = false }: { autoIntroReady?: boolean }) {

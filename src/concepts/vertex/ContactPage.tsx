...
export function VertexContactPage() {
  ...
  return (
    <main id="top" className="concept-vertex relative">
      ...
      <section className="relative border-b border-primary/20 bg-background pb-24 pt-36 md:pb-32 md:pt-44">
        <div className="mx-auto grid max-w-5xl gap-14 px-6 md:grid-cols-2 md:items-start">
          <div>
            <Reveal>
              ...
              <h1 className="mt-4 text-[clamp(2.2rem,5vw,3.4rem)] font-bold leading-[1.03]">{contactInfo.heading}</h1>
            </Reveal>
            <Reveal delay={0.1}>

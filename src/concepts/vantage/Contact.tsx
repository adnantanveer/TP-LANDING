    ...
    <section id="contact" className="relative overflow-hidden bg-background py-28 md:py-36">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-16 px-6 md:grid-cols-2 md:items-start">
        <div>
          ...
          <Reveal delay={0.25}>
            <Link
              to="/concepts/vantage/contact"
              className="mt-10 inline-flex items-center gap-2 rounded-full border-b border-foreground/30 pb-1 text-sm text-foreground transition-colors hover:border-primary hover:text-primary"
            >
        ...
        <Reveal delay={0.15}>
          <div className="vantage-glass overflow-hidden rounded-[2rem]">

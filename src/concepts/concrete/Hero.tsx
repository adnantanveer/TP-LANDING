...
// Must match .concept-concrete's --primary in concrete.css.
const ACCENT = "oklch(0.56 0.23 27)";
 ...
 * kept identical across every concept per request. The bold typographic
 * statement that used to be the hero is now its own section (see
 * Statement.tsx). */
export function ConcreteHero({ autoIntroReady = false }: { autoIntroReady?: boolean }) {

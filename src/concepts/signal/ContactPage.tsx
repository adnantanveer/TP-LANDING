...
export function SignalContactPage() {
  ...
  return (
    <main id="top" className="concept-signal relative">
      ...
      <section className="relative border-b border-border bg-background pb-24 pt-36 md:pb-32 md:pt-44">
        <div className="mx-auto grid max-w-6xl gap-16 px-6 md:grid-cols-2 md:items-start">
          <div>
            <Reveal>
              <h1 className="text-[clamp(2.4rem,5.5vw,3.8rem)] font-semibold leading-[1.02]">{contactInfo.heading}</h1>
            </Reveal>
            <Reveal delay={0.1}>

...
const fieldClass =
  "w-full rounded-xl border border-border bg-background px-5 py-4 text-sm text-foreground placeholder:text-muted-foreground/70 outline-none transition-colors focus:border-primary";
...
export function CrestContactPage() {
        ...
        <div className="relative mx-auto grid max-w-6xl gap-14 px-6 md:grid-cols-2 md:items-start">
          <div>
            <Reveal>
              ...
              <h1 className="mt-5 text-[clamp(1.9rem,4.6vw,3.2rem)] leading-[1.05]">{contactInfo.heading}</h1>
            </Reveal>
            <Reveal delay={0.1}>
